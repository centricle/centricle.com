...
Senior software engineer. 24 years building for the web.

Django, Wagtail, Python. WordPress when it's the right tool. Available for contract work.
...
**[centricle.com](https://centricle.com)** — full portfolio
